describe('Suppot Page Auth User - Relentless Health Website', () => {
    ...
    it('Send message successfully', function() {
        const { subject, message, messageSentAlert }=this.supportPage.SendMessageLoggedUser;
